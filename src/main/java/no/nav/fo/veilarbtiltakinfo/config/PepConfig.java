...
public class PepConfig {
    ...
    public VeilarbAbacPepClient pepClient(Pep pep) {
        ...
        return VeilarbAbacPepClient.ny()
                ...
                .brukAktoerId(()->unleashService.isEnabled("veilarbtiltakinfo.veilarbabac.aktor"))
                .sammenlikneTilgang(()->unleashService.isEnabled("veilarbtiltakinfo.veilarbabac.sammenlikn"))
                .foretrekkVeilarbAbacResultat(()->unleashService.isEnabled("veilarbtiltakinfo.veilarbabac.foretrekk_veilarbabac"))
                .bygg();
    }
